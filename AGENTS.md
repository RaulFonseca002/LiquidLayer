...
Current milestone: **land the completed S1-S5 headless framework, then begin S6 on `experiment/stage2`**. The local headless traceability gates pass; remote platform CI remains part of S7.
